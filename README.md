# nature-kitakyushu_ichiki — モックアップと WordPress 化

<!-- scan で自動生成。無いときだけ作られる（人が書き足した分は消さない） -->
...
| **Ichiki を直す** | [開発者向け資料](.claude/ichiki/docs/開発者向け資料.md) |
...
| `acf-map.yaml` | フィールド台帳。`scan` で出し直せる |
| `CLAUDE.md` | 案件の実装ルール |
